...
const Navbar = () => {
    return (
        <div className="flex items-center justify-between p-4 ">
            ...
            <div className="flex items-center max-sm:gap-1 gap-6 justify-end w-full">
              ...
              <span className="text-xs leading-3 font-medium">Samet Furkan</span>
              <span className="text-[10px] text-gray-500 text-right">Role</span>
            </div>
            <Image src="/icons/avatar.png" alt="" width={36} height={36} className="rounded-full" />
            </div>
