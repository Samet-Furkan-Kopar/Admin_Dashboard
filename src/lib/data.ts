...
export const calendarEvents = [
  {
    ...
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 2, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 2, 9, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 2, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 2, 10, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() - 2, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 1, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 1, 11, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 1, 11, 45),
  },
];
